  ...
  return (
    <div className="mx-[10%] my-20">
        ...
        <div className="flex flex-col justify-center items-center">
            ...
            <h2 className='text-base font-medium mt-2'>Free Shipping</h2>
            <p className='text-base text-black/60 text-center mt-2'>Enjoy fully free Shipping At <br /> your doorstep</p>
        </div>
        <div className="flex flex-col justify-center items-center">
            <div className='w-14 h-14 bg-black flex items-center justify-center rounded-full'>
            ...
            <h2 className='text-base font-medium mt-2'>Securety Payments </h2>
            <p className='text-base text-black/60 text-center mt-2'>Payment thorugh the most secure <br /> payment method</p>
        </div>
        <div className="flex flex-col justify-center items-center">
            <div className='w-14 h-14 bg-black flex items-center justify-center rounded-full'>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h2 className='text-base font-medium mt-2'>14-Day Returns </h2>
            <p className='text-base text-black/60 text-center mt-2'> Buy thorugh the app to get <br /> return policy</p>
        </div>
        <div className="flex flex-col justify-center items-center">
            <div className='w-14 h-14 bg-black flex items-center justify-center rounded-full'>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h2 className='text-base font-medium mt-2'>24/7 Support </h2>
            <p className='text-base text-black/60 text-center mt-2'> Get 24/7 support policy to <br /> report or any issue</p>
        </div>
    </div>
    </div>
  )
