              ...
              products.map(product =>
                <div key={product._id} className="h-fit border rounded-[10px]">
                  <div className="border rounded-t-[10px]">
                    <img className='w-[400px] sm:w-[500px] h-[300px] sm:h-[400px] rounded-t-[10px]' src={product.picture} alt="" />
                  </div>
                  <div className="mx-3 pb-3">
                    ...
                    <div className="border-t py-2.5">
                      <div className="flex justify-between mt-2 ">
                        <p className='text-xs sm:text-sm'>Resell Price : <span className='font-medium text-green-800'>$ {product.resellPrice}</span></p>
                        <p className='text-xs sm:text-sm'>Orginal Price : <span className='font-medium text-green-800'>${product.OrginalPrice}</span></p>
                      </div>
                      <div className="flex justify-between ">
                        <p className='text-xs sm:text-sm mt-2'>Post On : {product.postTime}</p>
                        <p className='text-xs sm:text-sm mt-2'>Used : {product.yearsOfUse} years</p>
                      </div>
                      <p className='mt-2 flex gap-x-2 items-center text-xs sm:text-sm'>
                        <span>
